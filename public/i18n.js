...
(function (global) {
  ...
  var STRINGS = {
    de: {
      ...
      streakLine: "Serie ohne Fehler: {n} · Rekord: {best}",
      wrongPctTitle: "Anteil falscher Antworten",
      correctExcl: "Richtig!",
      ...
      docTitleSettings: "Einstellungen — Artikel Drill",
      docTitleStats: "Statistik — Artikel Drill",
      masterPctLabel: "Anteil gelernter Wörter, der für das nächste Niveau nötig ist",
      wrongPauseLabel: "Nach einem Fehler nicht automatisch weiter, sondern auf Bestätigung warten",
      swearLabel: "Schimpf- und Kraftausdrücke anzeigen",
      noPlural: "kein Plural",
      delayRightLabel: "Pause nach einer richtigen Antwort",
      delayWrongLabel: "Pause nach einer falschen Antwort (bei automatischem Weiter)",
      secondsShort: "s",
      continueCorrectArticle: "Wähle den richtigen Artikel, um fortzufahren",
      signInLink: "Anmelden",
      ...
      bestStreakLine: "Längste Serie ohne Fehler: {best}",
      searchPlaceholder: "Wort oder Übersetzung suchen…",
      searchAria: "In der Statistik suchen",
    ...
    en: {
      ...
      streakLine: "Streak without mistakes: {n} · best: {best}",
      wrongPctTitle: "Share of wrong answers",
      correctExcl: "Correct!",
      ...
      account: "Account",
      settings: "Settings",
      docTitleSettings: "Settings — Artikel Drill",
      docTitleStats: "Statistics — Artikel Drill",
      masterPctLabel: "Percentage of words required to unlock the next level",
      wrongPauseLabel: "After a mistake, don't advance automatically — wait for confirmation",
      swearLabel: "Show swear and vulgar words",
      noPlural: "no plural",
      delayRightLabel: "Delay after a correct answer",
      delayWrongLabel: "Delay after a wrong answer (when advancing automatically)",
      secondsShort: "s",
      continueCorrectArticle: "Select the correct article to continue",
      signInLink: "Sign in",
      ...
      bestStreakLine: "Longest streak without mistakes: {best}",
      searchPlaceholder: "Search word or translation…",
      searchAria: "Search the statistics",
    ...
    ru: {
      ...
      streakLine: "Серия без ошибок: {n} · рекорд: {best}",
      wrongPctTitle: "Доля неправильных ответов",
      correctExcl: "Верно!",
      ...
      account: "Аккаунт",
      settings: "Настройки",
      docTitleSettings: "Настройки — Artikel Drill",
      docTitleStats: "Статистика — Artikel Drill",
      masterPctLabel: "Процент слов, необходимый для перехода на следующий уровень",
      wrongPauseLabel: "После ошибки не переключать слово автоматически, а ждать подтверждения",
      swearLabel: "Показывать ругательные и матерные слова",
      noPlural: "нет мн. числа",
      delayRightLabel: "Задержка после правильного ответа",
      delayWrongLabel: "Задержка после неправильного ответа (при автопереходе)",
      secondsShort: "с",
      continueCorrectArticle: "Выбери правильный артикль, чтобы продолжить",
      ...
      bestStreakLine: "Рекордная серия без ошибок: {best}",
      searchPlaceholder: "Поиск слова или перевода…",
      searchAria: "Поиск по статистике",
