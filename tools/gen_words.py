...
DATA = {
    "A1": {
        "der": ["Tag","Mann","Tisch","Stuhl","Baum","Hund","Apfel","Ball","Berg",
                ...
                "Schnee","Wind","Himmel","Stern","Mond","Preis","Euro","Platz","Freund",
                "Lehrer","Arzt","Zahn"],
    ...
    "A2": {
        "der": ["Beruf","Urlaub","Termin","Ausflug","Flughafen","Bahnhof","Markt",
                "Supermarkt","Weg","Unfall","Fehler","Wunsch","Traum",
...
GOETHE_B1_ADD = {
    "der": [
        ...
        "Vertreter", "Vortrag", "Wert", "Wetterbericht", "Wirt",
    ...
    "das": [
        ...
        "Leder", "Lexikon", "Loch", "Lokal", "Magazin", "Material", "Virus",
...
WIKI_NEWS_ADD = {
    ...
    "C1": {
        ...
        "das": [
            ...
            "Exil", "Experiment", "Familienunternehmen", "Feedback", "Festzelt", "Fett",
            ...
            "Pixel", "Podium", "Polizeipräsidium", "Portal", "Portfolio", "Privatleben", "Pulverfass",
